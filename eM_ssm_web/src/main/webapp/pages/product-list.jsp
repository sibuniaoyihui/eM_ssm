	...
	<div class="wrapper">
			...
			<section class="content">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="href='${pageContext.request.contextPath}/pages/product-add.jsp'">
											<i class="fa fa-file-o"></i> 新建
										</button>
										<button type="button" class="btn btn-default" title="删除">
											<i class="fa fa-trash-o"></i> 删除
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
                                ...
                                <c:forEach begin="1" end="5" var="pageNum">
									<c:if test="${pageNum <= pageInfo.pages}">
                                        ...
                                        <a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
									</c:if>
                                </c:forEach>
								</c:if>
								<c:if test="${pageInfo.pageNum+2 >5}">
								...
								<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2014-2019 <a
				href="https://sibuniaoyihui.github.io/">研究院研发部</a>.
