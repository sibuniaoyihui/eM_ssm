			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/user/findAll.do?page=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
								...
								<c:if test="${pageInfo.pageNum+2 <= 5}">
									<c:forEach begin="1" end="5" var="pageNum">
										<c:if test="${pageNum <= pageInfo.pages}">
											...
											<a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
										</c:if>
									</c:forEach>
								</c:if>
								<c:if test="${pageInfo.pageNum+2 >5}">
								...
								<li><a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
